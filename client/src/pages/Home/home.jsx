      ...
      <div className="home-container">
        <div className="home-header">
          ...
          <p className="intro">
            ...
            <span>Chart.js!</span> This platform is designed to help you easily
            visualize JSON data using intuitive charts and graphs. This website
            was designed to provide you with the flexibility to explore and
            interpret your data in a meaningful way.
          </p>
        </div>
